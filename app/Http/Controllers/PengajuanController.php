...
class PengajuanController  extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pengajuan.pengajuan', compact('datas'));
    }
    ...
    public function create()
    {
        ...
        $datas = Partner::get();
        return view('pengajuan.create', compact('datas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        Pengajuan::create([
            ...
            'tipe_test'=>$request->input('tipetest'),
    ...
    public function show($id)
    {
        ...
        return view('pengajuan.show', compact('data'), compact('datas'));
    }
    ...
    {   
        $data = Pengajuan::findOrFail($id);
        $datas = Partner::get();
        return view('pengajuan.edit',compact('datas'), compact('data'));
    }
